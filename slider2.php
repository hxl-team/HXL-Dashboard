                    ...
                    <td style="vertical-align: top;" >
                        <div style="margin: 0px 10px 10px 0px;">
                            <form name="locForm" style="margin: 20px 0px 10px 0px;" action="" >Location (all admin levels and camps):<br />
                                <select id="locForm" onchange="refreshSlide2()" class="btn" name="locations" style="width: 250px; text-align: left;" >
                                    <option value="all_pop">* All camps</option>
                                </select>    
                            </form>
                            <form name="sexForm" onchange="refreshSlide2()" style="margin: 0px 0px 10px 0px;">Sex categories:<br />
                                <select id="sexForm" class="btn" name="sex" style="width: 250px; text-align: left;" >
                                    <option value="all_pop">* All sex categories</option>
                                </select>
                            </form>
                            <form name="ageForm" onchange="refreshSlide2()" style="margin: 0px 0px 10px 0px;">Age groups:<br />
                                <select id="ageForm" class="btn" name="age" style="width: 250px; text-align: left;" >
                                    <option value="all_pop">* All ages</option>
                                </select>
                            </form>
                            <form name="originForm" onchange="refreshSlide2()" style="margin: 0px 0px 10px 0px;">Country of origin:<br />
                                <select id="originForm" class="btn" name="origin" style="width: 250px; text-align: left;" >
                                    <option value="all_pop">* All countries</option>
                                </select>
                            </form>
                            <form name="sourceForm" onchange="refreshSlide2()" style="margin: 0px 0px 0px 0px;">Data source:<br />
